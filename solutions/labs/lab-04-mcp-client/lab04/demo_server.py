...
def draft_incident_comment(
    ...
    return {"proposal_id": "PROP-LAB04", "incident_id": incident_id, "body": body, "requested_by": requested_by, "status": "pending"}
...
app = Starlette(routes=[Route("/health", health), Mount("/mcp", mcp.streamable_http_app())], lifespan=lifespan)
